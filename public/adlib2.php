...
if (strlen($_GET['story']) > 0)
{
    $text = trim($_GET['story']);
    $text = nl2br($text);
...
<body>
<form class="form-style-7" method="get">
<h1>Story</h1>
<dl><?php echo $text; ?></dl>
<ul>
<li>
    <label for="story">Story</label>
    <textarea rows="6" cols="50" name="story"><?php echo htmlspecialchars($_GET['story']); ?></textarea>
